...
var ft;
function pt() {
  return ft || (ft = 1, process.env.NODE_ENV === "production" ? yr.exports = Vt() : yr.exports = Wt()), yr.exports;
}
/**
 * @license React
...
process.env.NODE_ENV === "production" ? Nr.exports = Yt() : Nr.exports = Ut();
var Bt = Nr.exports;
const zt = Bt.jsx, qt = ({ children: z }) => /* @__PURE__ */ zt("p", { className: "message", children: z });
export {
  qt as Error
};
