...
function Yo() {
  return _n || (_n = 1, function(e, t) {
    process.env.NODE_ENV !== "production" && function() {
      ...
      var Ae = !1, Ve = !1, xe = !1, fe = !1, me = !1, le = {
      ...
      function ft(r, n, u) {
        var l, v = {}, T = null, _ = null, x = null, z = null;
        if (n != null) {
          mr(n) && (_ = n.ref, xr(n)), Ne(n) && (Ye(n.key), T = "" + n.key), x = n.__self === void 0 ? null : n.__self, z = n.__source === void 0 ? null : n.__source;
          for (l in n)
        ...
        return Be(r, T, _, x, z, O.current, v);
      }
      function dt(r, n) {
      ...
      function pt(r, n, u) {
        ...
        var l, v = w({}, r.props), T = r.key, _ = r.ref, x = r._self, z = r._source, ee = r._owner;
        if (n != null) {
      ...
      function Fe(r, n, u, l, v) {
        ...
        if (_) {
          var x = r, z = v(x), ee = l === "" ? jr + qe(x, 0) : l;
          if (er(z)) {
            var ne = "";
            ...
            z != null && ($e(z) && (z.key && (!x || x.key !== z.key) && Ye(z.key), z = dt(
              z,
...
Your code should look like: 
  const MyComponent = lazy(() => import('./MyComponent'))`, v), v.default;
      ...
      function d(r) {
        return !!(typeof r == "string" || typeof r == "function" || r === f || r === g || me || r === h || r === k || r === j || fe || r === Z || Ae || Ve || xe || typeof r == "object" && r !== null && (r.$$typeof === Y || r.$$typeof === A || r.$$typeof === m || r.$$typeof === C || r.$$typeof === R || // This needs to include all possible module reference object
...
`), z = l.stack.split(`
`), ee = x.length - 1, ne = z.length - 1; ee >= 1 && ne >= 0 && x[ee] !== z[ne]; )
              ne--;
            for (; ee >= 1 && ne >= 0; ee--, ne--)
              if (x[ee] !== z[ne]) {
                if (ee !== 1 || ne !== 1)
                  do
                    if (ee--, ne--, ne < 0 || x[ee] !== z[ne]) {
                      var oe = `
          ...
          for (var _ in r)
            if (T(r, _)) {
              ...
              try {
                ...
                x = r[_](n, _, l, u, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
              } catch (ee) {
                x = ee;
              }
              x && !(x instanceof Error) && (Wr(v), E("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", l || "React class", u, _, typeof x), Wr(null)), x instanceof Error && !(x.message in an) && (an[x.message] = !0, Wr(v), E("Failed %s type: %s", u, x.message), Wr(null));
            }
        }
      }
      function ar(r) {
...
Check the top-level render call using <` + u + ">.");
      ...
      function pn(r, n, u) {
        ...
        var x = ft.apply(this, arguments);
        if (x == null)
          return x;
        if (l)
          for (var z = 2; z < arguments.length; z++)
            fn(arguments[z], r);
        return r === f ? To(x) : dn(x), x;
      }
      var hn = !1;
      function Po(r) {
...
function Uo() {
  ...
  function re(s, p, w) {
    this.props = s, this.context = p, this.refs = Z, this.updater = w || A;
  }
  ...
  function me(s, p, w, M, D) {
    ...
    if (K)
      return K = s, D = D(K), s = M === "" ? "." + fe(K, 0) : M, L(D) ? (w = "", s != null && (w = s.replace(xe, "$&/") + "/"), me(D, p, w, "", function(Q) {
        return Q;
      })) : D != null && (Ae(D) && (D = ge(D, w + (!D.key || K && K.key === D.key ? "" : ("" + D.key).replace(xe, "$&/") + "/") + s)), p.push(D)), 1;
    if (K = 0, M = M === "" ? "." : M + ":", L(s))
  ...
  }, F.isValidElement = Ae, F.lazy = function(s) {
...
function zo() {
  return Rn || (Rn = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function Ae(a) {
      return !!(typeof a == "string" || typeof a == "function" || a === i || a === f || pe || a === c || a === C || a === R || S || a === A || L || I || O || typeof a == "object" && a !== null && (a.$$typeof === j || a.$$typeof === k || a.$$typeof === h || a.$$typeof === g || a.$$typeof === m || // This needs to include all possible module reference object
      // types supported by any Flight configuration anywhere since
      // we don't know which Flight build this will end up being used
      // with.
...
` + $[ae].replace(" at new ", " at ");
    ...
    function $e(a, d) {
      {
        var y = function() {
          Ar || (Ar = !0, P("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", d));
        };
    ...
    function jr(a, d) {
      {
        var y = function() {
          xr || (xr = !0, P("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", d));
        };
...
function Bo() {
  ...
  function h(g, m, C) {
    var R, k = {}, j = null, A = null;
    C !== void 0 && (j = "" + C), m.key !== void 0 && (j = "" + m.key), m.ref !== void 0 && (A = m.ref);
    for (R in m)
      i.call(m, R) && !f.hasOwnProperty(R) && (k[R] = m[R]);
    if (g && g.defaultProps)
      for (R in m = g.defaultProps, m)
        k[R] === void 0 && (k[R] = m[R]);
    return { $$typeof: t, type: g, key: j, ref: A, props: k, _owner: c.current };
  }
...
var te = "-ms-", Cr = "-moz-", X = "-webkit-", Un = "comm", nt = "rule", zt = "decl", Xo = "@import", zn = "@keyframes", Jo = "@layer", Bn = Math.abs, Bt = String.fromCharCode, Nt = Object.assign;
function Zo(e, t) {
...
function ua(e) {
  return na(Zr("", null, null, null, [""], e = ta(e), 0, [0], e));
}
function Zr(e, t, o, i, c, f, h, g, m) {
  for (var C = 0, R = 0, k = h, j = 0, A = 0, Y = 0, Z = 1, re = 1, G = 1, P = 0, U = "", L = c, I = f, O = i, S = U; re; )
    switch (Y = P, P = Oe()) {
      case 40:
        if (Y != 108 && de(S, k - 1) == 58) {
          Xr(S += N(At(P), "&", "&\f"), "&\f", Bn(C ? g[C - 1] : 0)) != -1 && (G = -1);
          break;
        }
      case 34:
      case 39:
      ...
      case 0:
        switch (P) {
          ...
          case 125:
            re = 0;
          case 59 + R:
            G == -1 && (S = N(S, /\f/g, "")), A > 0 && Pe(S) - k && Sr(A > 32 ? Tn(S + ";", i, o, k - 1, m) : Tn(N(S, " ", "") + ";", i, o, k - 2, m), m);
            break;
          case 59:
            S += ";";
          default:
      ...
      default:
        ...
        switch (S += Bt(P), P * Z) {
          ...
          case 44:
            ...
            break;
          case 64:
            Je() === 45 && (S += At(Oe())), j = Je(), R = k = Pe(U = S += sa(Jr())), P++;
            break;
          case 45:
            Y === 45 && Pe(S) == 2 && (Z = 0);
        }
...
function On(e, t, o, i, c, f, h, g, m, C, R, k) {
  for (var j = c - 1, A = c === 0 ? f : [""], Y = Gn(A), Z = 0, re = 0, G = 0; Z < i; ++Z)
    for (var P = 0, U = lr(e, j + 1, j = Bn(re = h[Z])), L = e; P < Y; ++P)
      (L = qn(re > 0 ? A[P] + " " + U : N(U, /&\f/g, A[P]))) && (m[G++] = L);
  return at(e, t, o, c === 0 ? nt : g, m, C, R, k);
}
function ca(e, t, o, i) {
  return at(e, t, o, Un, Bt(ea()), lr(e, 2, -2), 0, i);
}
...
function pa(e, t, o, i) {
  if (e.length > -1 && !e.return)
    switch (e.type) {
      ...
      case nt:
        if (e.length)
          return Qo(o = e.props, function(c) {
...
`, Gt = typeof window < "u" && "HTMLElement" in window, va = !!(typeof SC_DISABLE_SPEEDY == "boolean" ? SC_DISABLE_SPEEDY : typeof process < "u" && process.env !== void 0 && process.env.REACT_APP_SC_DISABLE_SPEEDY !== void 0 && process.env.REACT_APP_SC_DISABLE_SPEEDY !== "" ? process.env.REACT_APP_SC_DISABLE_SPEEDY !== "false" && process.env.REACT_APP_SC_DISABLE_SPEEDY : typeof process < "u" && process.env !== void 0 && process.env.SC_DISABLE_SPEEDY !== void 0 && process.env.SC_DISABLE_SPEEDY !== "" ? process.env.SC_DISABLE_SPEEDY !== "false" && process.env.SC_DISABLE_SPEEDY : process.env.NODE_ENV !== "production"), Pn = /invalid hook call/i, qr = /* @__PURE__ */ new Set(), ya = function(e, t) {
...
function Mt(e) {
  ...
  for (t = Math.abs(e); t > Gr; t = t / Gr | 0)
    o = xn(t % Gr) + o;
  return (xn(t % Gr) + o).replace(_a, "$1-$2");
}
var xt, Zn = 5381, Ke = function(e, t) {
...
var ro = typeof Symbol == "function" && Symbol.for, to = ro ? Symbol.for("react.memo") : 60115, Ea = ro ? Symbol.for("react.forward_ref") : 60112, Ra = { childContextTypes: !0, contextType: !0, contextTypes: !0, defaultProps: !0, displayName: !0, getDefaultProps: !0, getDerivedStateFromError: !0, getDerivedStateFromProps: !0, mixins: !0, propTypes: !0, type: !0 }, Sa = { name: !0, length: !0, prototype: !0, caller: !0, callee: !0, arguments: !0, arity: !0 }, no = { $$typeof: !0, compare: !0, defaultProps: !0, displayName: !0, propTypes: !0, type: !0 }, Ca = ((xt = {})[Ea] = { $$typeof: !0, render: !0, defaultProps: !0, displayName: !0, propTypes: !0 }, xt[to] = no, xt);
function jn(e) {
  return ("type" in (t = e) && t.type.$$typeof) === to ? no : "$$typeof" in e ? Ca[e.$$typeof] : Ra;
  var t;
}
var ka = Object.defineProperty, Oa = Object.getOwnPropertyNames, In = Object.getOwnPropertySymbols, Ta = Object.getOwnPropertyDescriptor, Pa = Object.getPrototypeOf, Dn = Object.prototype;
function oo(e, t, o) {
  if (typeof t != "string") {
    if (Dn) {
      var i = Pa(t);
    ...
    for (var f = jn(e), h = jn(t), g = 0; g < c.length; ++g) {
      var m = c[g];
      if (!(m in Sa || o && o[m] || h && m in h || f && m in f)) {
        var C = Ta(t, m);
        try {
          ka(e, m, C);
        } catch {
...
var Aa = process.env.NODE_ENV !== "production" ? { 1: `Cannot create styled-component for component: %s.
...
function yr(e) {
  for (var t = [], o = 1; o < arguments.length; o++)
    t[o - 1] = arguments[o];
  return process.env.NODE_ENV === "production" ? new Error("An error occurred. See https://github.com/styled-components/styled-components/blob/main/packages/styled-components/src/utils/errors.md#".concat(e, " for more information.").concat(t.length > 0 ? " Args: ".concat(t.join(", ")) : "")) : new Error(xa.apply(void 0, cr([Aa[e]], t, !1)).trim());
}
var ja = function() {
  function e(t) {
...
}, Da = "style[".concat(Qe, "][").concat(Jn, '="').concat(st, '"]'), Na = new RegExp("^".concat(Qe, '\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)')), $a = function(e, t, o) {
  ...
  for (var o, i = ((o = t.textContent) !== null && o !== void 0 ? o : "").split(qt), c = [], f = 0, h = i.length; f < h; f++) {
    ...
    if (g) {
      ...
      if (m) {
        ...
        C !== 0 && (Ia(R, C), $a(e, R, m[3]), e.getTag().insertRules(C, c)), c.length = 0;
      } else
        c.push(g);
    }
  }
...
var ao = function(e) {
...
}(), $n = Gt, Ya = { isServer: !Gt, useCSSOMInjection: !va }, io = function() {
  function e(t, o, i) {
    t === void 0 && (t = dr), o === void 0 && (o = {});
    var c = this;
    this.options = _e(_e({}, Ya), t), this.gs = o, this.names = new Map(i), this.server = !!t.isServer, !this.server && Gt && $n && ($n = !1, function(f) {
      for (var h = document.querySelectorAll(Da), g = 0, m = h.length; g < m; g++) {
        var C = h[g];
        C && C.getAttribute(Qe) !== Xn && (Fa(f, C), C.parentNode && C.parentNode.removeChild(C));
      }
      ...
      return function(f) {
        for (var h = f.getTag(), g = h.length, m = "", C = function(k) {
          ...
          if (j === void 0)
            return "continue";
          var A = f.names.get(j), Y = h.getGroup(k);
          if (A === void 0 || Y.length === 0)
            return "continue";
          var Z = "".concat(Qe, ".g").concat(k, '[id="').concat(j, '"]'), re = "";
          A !== void 0 && A.forEach(function(G) {
  ...
  return e.registerId = function(t) {
    ...
    return this.tag || (this.tag = (t = function(o) {
      ...
      return o.isServer ? new Wa(c) : i ? new Ma(c) : new Va(c);
...
function Ba(e) {
  var t, o, i, c = e === void 0 ? dr : e, f = c.options, h = f === void 0 ? dr : f, g = c.plugins, m = g === void 0 ? ut : g, C = function(j, A, Y) {
    return Y.startsWith(o) && Y.endsWith(o) && Y.replaceAll(o, "").length > 0 ? ".".concat(t) : j;
  }, R = m.slice();
  R.push(function(j) {
    j.type === nt && j.value.includes("&") && (j.props[0] = j.props[0].replace(Ua, o).replace(i, C));
  }), h.prefix && R.push(pa), R.push(la);
  var k = function(j, A, Y, Z) {
    A === void 0 && (A = ""), Y === void 0 && (Y = ""), Z === void 0 && (Z = "&"), t = Z, o = A, i = new RegExp("\\".concat(o, "\\b"), "g");
    var re = j.replace(za, ""), G = ua(Y || A ? "".concat(Y, " ").concat(A, " { ").concat(re, " }") : re);
    h.namespace && (G = so(G, h.namespace));
    var P = [];
    return rt(G, fa(R.concat(da(function(U) {
      return P.push(U);
    })))), P;
  };
  return k.hash = m.length ? m.reduce(function(j, A) {
    return A.name || yr(15), Ke(j, A.name);
  }, Zn).toString() : "", k;
}
var qa = new io(), Wt = Ba(), uo = kr.createContext({ shouldForwardProp: void 0, styleSheet: qa, stylis: Wt });
uo.Consumer;
...
var co = function(e) {
  ...
  for (var c in e) {
    var f = e[c];
    e.hasOwnProperty(c) && !co(f) && (Array.isArray(f) && f.isCss || pr(f) ? i.push("".concat(Mn(c), ":"), f, ";") : hr(f) ? i.push.apply(i, cr(cr(["".concat(c, " {")], lo(f), !1), ["}"], !1)) : i.push("".concat(Mn(c), ": ").concat((t = c, (o = f) == null || typeof o == "boolean" || o === "" ? "" : typeof o != "number" || o === 0 || t in ha || t.startsWith("--") ? String(o).trim() : "".concat(o, "px")), ";")));
  }
  return i;
};
function Ze(e, t, o, i) {
...
var Ka = Qn(st), Xa = function() {
  function e(t, o, i) {
    this.rules = t, this.staticRulesId = "", this.isStatic = process.env.NODE_ENV === "production" && (i === void 0 || i.isStatic) && Ha(t), this.componentId = o, this.baseHash = Ke(Ka, o), this.baseStyle = i, io.registerId(o);
  }
  return e.prototype.generateAndInjectStyles = function(t, o, i) {
    ...
    if (this.isStatic && !i.hash)
      ...
      if (C) {
        var A = Mt(m >>> 0);
        o.hasNameForId(this.componentId, A) || o.insertRules(this.componentId, A, i(C, ".".concat(A), void 0, this.componentId)), c = Xe(c, A);
      }
    }
    return c;
  }, e;
...
function Ja(e, t, o) {
  var i = Ht(e), c = e, f = !jt(e), h = t.attrs, g = h === void 0 ? ut : h, m = t.componentId, C = m === void 0 ? function(L, I) {
    var O = typeof L != "string" ? "sc" : An(L);
    It[O] = (It[O] || 0) + 1;
    var S = "".concat(O, "-").concat(wa(st + O + It[O]));
  ...
  }(e) : R, j = t.displayName && t.componentId ? "".concat(An(t.displayName), "-").concat(t.componentId) : t.componentId || C, A = i && c.attrs ? c.attrs.concat(g).filter(Boolean) : g, Y = t.shouldForwardProp;
  ...
  var G = new Xa(o, j, i ? c.componentStyle : void 0);
  function P(L, I) {
    return function(O, S, pe) {
      var ge = O.attrs, Ae = O.componentStyle, Ve = O.defaultProps, xe = O.foldedComponentIds, fe = O.styledComponentId, me = O.target, le = kr.useContext(fo), we = Fn(), E = O.shouldForwardProp || we.shouldForwardProp;
      process.env.NODE_ENV !== "production" && ur.useDebugValue(fe);
      var Ee = ma(S, le, Ve) || dr, he = function(H, K, B) {
      ...
      for (var w in he)
        he[w] === void 0 || w[0] === "$" || w === "as" || w === "theme" && he.theme === Ee || (w === "forwardedAs" ? p.as = he.forwardedAs : E && !E(w, s) || (p[w] = he[w], E || process.env.NODE_ENV !== "development" || Ko(w) || Vn.has(w) || !Lt.has(s) || (Vn.add(w), console.warn('styled-components: it looks like an unknown prop "'.concat(w, '" is being sent through to the DOM, which will likely trigger a React console error. If you would like automatic filtering of unknown props, you can opt-into that behavior via `<StyleSheetManager shouldForwardProp={...}>` (connect an API like `@emotion/is-prop-valid`) or consider using transient props (`$` prefix for automatic filtering.)')))));
      var M = function(H, K) {
  ...
  return U.attrs = A, U.componentStyle = G, U.displayName = k, U.shouldForwardProp = Y, U.foldedComponentIds = i ? Xe(c.foldedComponentIds, c.styledComponentId) : "", U.styledComponentId = j, U.target = i ? c.target : e, Object.defineProperty(U, "defaultProps", { get: function() {
  ...
  } }), process.env.NODE_ENV !== "production" && (ya(k, j), U.warnTooManyClasses = /* @__PURE__ */ function(L, I) {
    var O = {}, S = !1;
    return function(pe) {
...
function Yt(e, t, o) {
  ...
  var i = function(c) {
    for (var f = [], h = 1; h < arguments.length; h++)
      f[h - 1] = arguments[h];
    return e(t, o, Za.apply(void 0, cr([c], f, !1)));
  };
...
const Qa = ho.div``, ei = ({ children: e }) => /* @__PURE__ */ Cn(Qa, { children: /* @__PURE__ */ Cn("p", { className: "message", children: e }) });
export {
  ei as Error
};
