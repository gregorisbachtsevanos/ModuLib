var Nr = { exports: {} }, He = {}, yr = { exports: {} }, Ke = { exports: {} };
/**
 * @license React
      ...
      function _e(e, r, a, o, i) {
        ...
        if (Fe(e))
          ...
          if (typeof Lr == "function") {
            ...
            for (var Nt = Lr.call(ot), ut, Mt = 0; !(ut = Nt.next()).done; )
              A = ut.value, D = B + Ae(A, Mt++), M += _e(A, r, a, D, i);
          } else if (p === "object") {
            var it = String(e);
...
` + v[O].replace(" at new ", " at ");
          ...
          xr = !1, jr.current = p, bt(), Error.prepareStackTrace = i;
        }
...
var ft;
function vt() {
  return ft || (ft = 1, process.env.NODE_ENV === "production" ? yr.exports = Ut() : yr.exports = Vt()), yr.exports;
}
/**
 * @license React
...
Check the top-level render call using <` + c + ">.");
    ...
    var Pr = Or, kr = Tr;
    He.Fragment = X, He.jsx = Pr, He.jsxs = kr;
  }()), He;
}
var Ge = {};
/**
...
process.env.NODE_ENV === "production" ? Nr.exports = Bt() : Nr.exports = Yt();
var zt = Nr.exports;
const pt = zt.jsx, qt = ({ children: z }) => /* @__PURE__ */ pt("div", { children: /* @__PURE__ */ pt("p", { className: "message", children: z }) });
export {
  qt as Error
};
